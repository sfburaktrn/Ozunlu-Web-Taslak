...
export const pageKeywords: Record<Locale, Record<PageSeoKey, string>> = {
    ...
    en: {
        ...
        karlaMucadele: 'snow fighting, snow plow, front snow blade, side blade, salt spreader, winter maintenance vehicle, Özünlü',
    ...
    de: {
        ...
        karlaMucadele: 'Winterdienst, Schneepflug, Frontschild, Seitenschild, Salzstreuer, Winterdienstfahrzeug, Özünlü',
    ...
    bg: {
        ...
        karlaMucadele: 'борба със снега, снегорин, преден нож, страничен нож, разпръсквач сол, зимна поддръжка, Özünlü',
    ...
    ro: {
        ...
        karlaMucadele: 'deszăpezire, lamă zăpadă, lamă față, lamă laterală, împrăștiător sare, utilaj iarnă, Özünlü',
    ...
    ar: {
        ...
        karlaMucadele: 'مكافحة الثلوج, شفرة ثلج, شفرة أمامية, شفرة جانبية, ناثر ملح, مركبة شتاء, Özünlü',
    ...
    fr: {
        ...
        karlaMucadele: 'déneigement, lame à neige, lame avant, lame latérale, épandeur sel, véhicule hivernal, Özünlü',
    ...
    es: {
        ...
        karlaMucadele: 'quitanieves, cuchilla nieve, cuchilla frontal, cuchilla lateral, esparcidor sal, vehículo invierno, Özünlü',
    ...
    it: {
        ...
        karlaMucadele: 'antineve, lama neve, lama anteriore, lama laterale, spargisale, veicolo invernale, Özünlü',
    ...
    ru: {
        ...
        karlaMucadele: 'борьба со снегом, снегоочиститель, передний отвал, боковой отвал, разбрасыватель соли, зимняя техника, Özünlü',
    ...
    uk: {
        ...
        karlaMucadele: 'боротьба зі снігом, снігоочисник, передній відвал, бічний відвал, розкидач солі, зимова техніка, Özünlü',
