...
const PRODUCT_KEYS = ['g22', 'l500', 'm21'] as const;

const PRODUCT_META: Record<
    (typeof PRODUCT_KEYS)[number],
    { id: string; code: string; image: string }
> = {
    g22: { id: '1', code: 'ÖZ-G22', image: '/products/new-product-1.jpg' },
    l500: { id: '2', code: 'ÖZ-L500', image: '/products/new-product-2.jpg' },
    m21: { id: '4', code: 'ÖZ-M21', image: '/products/new-product-3.jpg' },
};
        ...
        () =>
            PRODUCT_KEYS.map((key) => {
                ...
                return {
                    ...
                    detailedInfo: [] as ReadyProduct['detailedInfo'],
                };
            }),
        [t]
    );
            ...
            <div className="w-full max-w-[1600px] mx-auto space-y-8 mb-24">
                ...
                >
                        ...
                        <div className="space-y-8">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-black leading-relaxed">{t.rich('features.item01Content', heroRichTextHandlers)}</p>
                                </div>
                            </div>
                    ...
                    <div className="w-full md:w-1/2 min-h-[400px] relative transition-all duration-700">
                        <Image src="/products/yari-romork-feature-new.jpg" alt={t('features.imageAlt')} fill className="object-cover rounded-[2rem]" />
                    </div>
                </motion.div>
            </div>
