...
const HERO_IMAGES = [
    '/images/ozunlu-sari-hardox-damperli-yari-romork-studyo.webp',
    '/images/ozunlu-turuncu-hardox-damperli-yari-romork-studyo.webp',
    '/images/ozunlu-beyaz-hardox-damperli-yari-romork-studyo.webp',
] as const;
