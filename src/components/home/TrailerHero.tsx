                ...
                >
                    ...
                    <div className="absolute inset-0">
                        <Image
                            ...
                            alt="Özünlü Yarı Römork ve Dorse Sistemleri"
                            fill
                    ...
                    <div className="relative h-full flex flex-col justify-end md:justify-center items-end p-6 pb-6 md:p-16">
                        ...
                        <div className="max-w-xl relative text-right">
                            {/* Desktop Watermark - Relative to text (Right aligned) */}
                            ...
                            >
                                Yola Hakim <br />
                                <span className="text-primary">Yükte Hafif</span>
                            </motion.h2>
                            ...
                            >
                                Yüksek ikinci el değeri, düşük işletme maliyeti ve uzun ömürlü yapı. Özünlü yarı römorkları ile lojistikte verimliliği zirveye taşıyın.
                            </motion.p>
