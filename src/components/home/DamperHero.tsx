    ...
    return (
        <section className="bg-white py-12">
            <div className="container mx-auto px-4">
                ...
                <div className="layout-fixed relative md:hidden">
                    ...
                    >
                        <Image
                            ...
                            loading="lazy"
                            sizes="100vw"
                            className="object-cover object-[88%_40%] sm:object-[90%_38%]"
                            quality={90}
                        />
                ...
                >
                    <div className="relative h-[400px] overflow-hidden bg-[#1a1a1a] lg:absolute lg:inset-0 lg:h-full">
                        <Image
                            src="/images/ozunlu-hardox-siyah-damper-kamyon.webp"
                            alt={t('imageAlt')}
                            fill
                            ...
                            className="object-cover object-[68%_36%] transition-transform duration-700 group-hover:scale-[1.02] lg:object-[82%_center] lg:group-hover:scale-105"
                            quality={90}
                        />
                    ...
                    <div className="relative z-10 bg-[#0c0c0e] px-8 py-7 lg:absolute lg:inset-0 lg:flex lg:items-center lg:justify-start lg:bg-transparent lg:p-12 xl:p-16">
                        ...
                        >
                            ...
                            <Link
                                href={{ pathname: '/damper', hash: 'teklif-formu' }}
                                className="group/link inline-flex items-center gap-2 rounded-full border border-white/35 bg-primary px-8 py-4 text-lg font-semibold text-white shadow-lg shadow-black/40 transition-all hover:bg-primary/90"
                            >
                                {tCommon('cta.teklifAl')}
                                <ArrowRight
                                    size={20}
