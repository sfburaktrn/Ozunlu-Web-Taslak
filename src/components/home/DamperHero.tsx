                ...
                >
                    <div className="absolute inset-0">
                        <Image
                            ...
                            className="object-cover object-[70%_center] md:object-[82%_center] group-hover:scale-105 transition-transform duration-700"
                            quality={90}
                        />
                    ...
                    <div className="relative z-10 h-full flex items-end md:items-center justify-start p-6 pb-6 md:p-12 lg:p-16">
                        ...
                        <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl relative text-left" dir={textDir}>
                            ...
                            <motion.p
                                ...
                                className="relative z-10 text-sm sm:text-base md:text-xl text-gray-300 mb-6 md:mb-8 max-w-xl text-left leading-relaxed drop-shadow-[0_2px_10px_rgba(0,0,0,0.7)]"
                            >
