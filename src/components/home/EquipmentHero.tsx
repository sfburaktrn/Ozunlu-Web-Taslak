                ...
                >
                    <div className="relative h-[240px] overflow-hidden bg-[#1a1a1a] sm:h-[280px] md:h-[320px] lg:absolute lg:inset-0 lg:h-full">
                        <Image
                            ...
                            className="object-cover object-[100%_45%] transition-transform duration-700 group-hover:scale-[1.02] sm:object-[66%_42%] md:object-[70%_40%] lg:object-[78%_center] lg:group-hover:scale-105"
                            quality={90}
                        />
