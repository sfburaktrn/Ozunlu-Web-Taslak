        ...
        <section className="pt-2 pb-12 bg-white">
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end md:justify-center items-start p-6 pb-6 md:p-16">
                        ...
                        <div className="max-w-xl relative text-left z-10" dir={textDir}>
                            ...
                            <motion.p
                                ...
                                className="typo-body-on-dark mb-6 md:mb-8 max-w-xl drop-shadow-[0_2px_10px_rgba(0,0,0,0.7)]"
                            >
