            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <div className="relative w-full h-full">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent md:bg-gradient-to-l md:from-black/80 md:via-black/40 md:to-transparent rtl:md:bg-gradient-to-r" />
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end md:justify-center items-end p-6 pb-6 md:p-16">
                        ...
                        <div className="absolute top-8 start-6 md:hidden z-0 pointer-events-none select-none">
                        ...
                        <div className="max-w-xl relative text-end z-10">

                            <div className="hidden md:block absolute -top-20 -end-10 z-0 pointer-events-none select-none">
                            ...
                            <motion.p
                                ...
                                className="text-xs md:text-lg text-gray-300 mb-6 md:mb-8 leading-relaxed ms-auto max-w-xl"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ArrowRight size={16} className="md:w-5 md:h-5 rtl:rotate-180" />
