                ...
                <div className="layout-fixed relative md:hidden">
                    ...
                    >
                        <Image
                            ...
                            loading="lazy"
                            sizes="100vw"
                            className="object-cover object-[100%_45%] sm:object-[95%_42%]"
                            quality={90}
                        />
                    ...
                    >
                        <div className="w-full text-left" dir={textDir}>
                            ...
                            >
                                <Link
                                    href={{ pathname: '/satis-sonrasi', hash: 'ek-ekipmanlar' }}
                ...
                >
                    <div className="relative h-[320px] overflow-hidden bg-[#1a1a1a] lg:absolute lg:inset-0 lg:h-full">
                        <Image
                            ...
                            className="object-cover object-[70%_40%] transition-transform duration-700 group-hover:scale-[1.02] lg:object-[78%_center] lg:group-hover:scale-105"
                            quality={90}
                        />
